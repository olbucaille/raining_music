...
function c_RegisterUser()
{
	...
	function c_reset_user($user)
	{
		...
		{
			$_SESSION['message'] = "Vous avez reset le user avec succËs, les informations serons actualisÈ la prochaine fois que vous vous connecterez(seul l'admin peut ‡ prÈsent se connecter!)";
			header("location:./template/MessageEtape.php");//redirection vers une page disant bravo t'as reussit \o/
	...
	function c_unreset_user($user)
	{
		...
		{
			$_SESSION['message'] = "Vous avez rÈactivÈ le user avec succËs, les informations serons actualisÈ la prochaine fois que vous vous connecterez le mot de passe est maintenant identique ‡ son login";
			header("location:./template/MessageEtape.php");//redirection vers une page disant bravo t'as reussit \o/
