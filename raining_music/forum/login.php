...
else
{
	...
	if(isset($_POST['username'], $_POST['password']))
	{
		...
		echo 'select Password,id from Membre where Login="'.$username.'"'; 
		$req = mysql_query('select Password,id from Membre where Login="'.$username.'"');
		...
		if($dn['password']==md5($password) and mysql_num_rows($req)>0)
		{
			...
			if(isset($_POST['memorize']) and $_POST['memorize']=='yes')
			{
				...
				setcookie('password', md5($password), $one_year);
			}
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
