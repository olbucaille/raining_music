...
if ($_POST ['kindOfObject'] == "salle") :
		...
		?> 
		avec comme mot(s) cl�(s) : "<i><?php echo $_POST['motcleSearch']?></i>" et un filtre sur : 
		<?php
	...
	<div>
		<span> <span> <span> <?php echo "ID du groupe en BdD: ".$infos['Id']; ?> </span>
             <?php if( $infos['Popularite']!=null):?>
            	...
            	else :echo "Popularite: cet(te) artiste n'est pas encore �valu�(e)";  ?></span>
            <?php endif;?>
...
<!-- fin de la boucle -->
									 ...
									 <?php
										...
										echo "<h2>Aucun r�sultat ne correspond � votre recherche</h2>";
										?>
