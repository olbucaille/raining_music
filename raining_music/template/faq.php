...
Toute personne de toute nationalité peut s'inscrire selon les termes définis dans les "Conditions Générales d'Utilisation" pour participer à la vie du site et notamment voter pour ses artistes préférés. Le service de mise à disposition des salles est réservé aux membres étant propriétaire d'une salle physique. L'inscription en tant qu'artiste est autorisée pour tous les membres. 

Je suis Artiste
  Pourquoi m'inscrire sur Raining Music ? 
Raining Music est tout d'abord un site communautaire permettant aux artistes de talent de présenter leurs oeuvres et de proposer leurs services pour des représentations dans les salles de concert que proposent d'autres membres. De plus cela permet aux fans de musique de participer à une aventure artistique passionnante.

En vous inscrivant en tant qu'artiste vous profiterez de l'immense vitrine que représente internet pour trouver des lieus de représentation et réaliser votre rêve. Grâce à l'espace communautaire, vous entrerez en relation avec des milliers de passionnés de musique (fans, musiciens, chanteurs etc..) qui pourront vous aider à partager votre talent. 

  Comment partager ma musique ? 
Tous les artistes souhaitant partager leur musique le peuvent grâce à la mise en place d'un player sur leur page de groupe. Les membres inscrits auront donc la possibilité d'écouter la musique uploadée préalablement sur notre site.
