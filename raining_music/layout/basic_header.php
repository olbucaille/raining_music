<?php 
// permet de charger la session courante : avec par exemple les donnÈes relative ‡ la connexion de l'utilisateur
session_start();
?>
<!DOCTYPE html >
<html lang="fr">
...
<title>RainingMusic - Soyez arros√© d'informations !</title>
</head>
